...
const Login = () => {
    ...
    return (
        <div className="flex grid grid-cols-12 place-content-center">
            <div className="col-start-5 col-span-4 relative flex flex-col justify-center min-h-screen overflow-hidden">
            <div className="w-full p-6 m-auto bg-white border-t-4 border-purple-600 rounded-md shadow-md border-top lg:max-w-md">
                    <h1 className="text-3xl font-semibold text-center text-purple-700">Feeds</h1>
